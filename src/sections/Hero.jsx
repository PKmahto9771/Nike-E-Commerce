...
const Hero = () => {
    ...
    return (
        <section className="w-full flex xl:flex-row flex-col justify-center min-h-screen gap-10 max-container" id="home">
            ...
            <div className="relative flex-1 flex justify-center items-center xl:min-h-screen mt-20 max-xl:py-40 bg-primary bg-hero bg-shoe collection bg-center">
                <img src={bigShoeImg} alt="shoe collection" width={490} height={400} className="object-contain relative z-10" />
